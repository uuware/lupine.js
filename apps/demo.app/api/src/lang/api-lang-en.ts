...
export const apiLangEn: OneLangProps = {
  ...
  langs: {
    ...
    'shared:send_and_copy_activation':
      'An Email has been sent to you with the authentication code. Please copy that authentication code to login or reset your password.',
