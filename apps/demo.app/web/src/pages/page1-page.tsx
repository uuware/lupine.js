...
export const Page1Page = async () => {
  ...
  const ref: RefProps = {
    onLoad: async (el: Element) => {
      nodeTest1.value =
        'parameter1: ' +
        getRenderPageProps().urlParameters?.parameter1 +
        ', option1: ' +
        getRenderPageProps().urlParameters?.option1;
    },
  };
  return (
    <div css={css} ref={ref} class='page1-top'>
      <div class='page1-box'>
        <div class='page1-title'>This is sample page1 (can be in different frames).</div>
