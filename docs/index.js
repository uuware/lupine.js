...
`:""}function lx(e,t){return cc(e,Rt.extend({schema:Ab},t))}Tr.exports.dump=cc;Tr.exports.safeDump=lx});var uc=S((YT,j)=>{"use strict";var An=Nl(),dc=pc();function Rn(e){return function(){throw new Error("Function "+e+" is deprecated and cannot be used.")}}j.exports.Type=q();j.exports.Schema=$e();j.exports.FAILSAFE_SCHEMA=Sn();j.exports.JSON_SCHEMA=fr();j.exports.CORE_SCHEMA=br();j.exports.DEFAULT_SAFE_SCHEMA=ot();j.exports.DEFAULT_FULL_SCHEMA=Mt();j.exports.load=An.load;j.exports.loadAll=An.loadAll;j.exports.safeLoad=An.safeLoad;j.exports.safeLoadAll=An.safeLoadAll;j.exports.dump=dc.dump;j.exports.safeDump=dc.safeDump;j.exports.YAMLException=tt();j.exports.MINIMAL_SCHEMA=Sn();j.exports.SAFE_SCHEMA=ot();j.exports.DEFAULT_SCHEMA=Mt();j.exports.scan=Rn("scan");j.exports.parse=Rn("parse");j.exports.compose=Rn("compose");j.exports.addConstructor=Rn("addConstructor")});var gc=S((JT,hc)=>{"use strict";var cx=uc();hc.exports=cx});var Pr=S((exports,module)=>{"use strict";var yaml=gc(),engines=exports=module.exports;engines.yaml={parse:yaml.safeLoad.bind(yaml),stringify:yaml.safeDump.bind(yaml)};engines.json={parse:JSON.parse.bind(JSON),stringify:function(e,t){let n=Object.assign({replacer:null,space:2},t);return JSON.stringify(e,n.replacer,n.space)}};engines.javascript={parse:function parse(str,options,wrap){try{return wrap!==!1&&(str=`(function() {
return `+str.trim()+`;
...
</svg>`;var jc=`<svg viewBox='0 0 24 24' width='20' height='20' fill='currentColor'>\r
...
`;var jp=`<h1 id="grid"><a class="header-anchor" href="#grid">#</a>Grid</h1><p>Responsive grid layout for displaying complex layouts.</p>
...
`;var jd=`<h1 id="server-src-app"><a class="header-anchor" href="#server-src-app">#</a>Server (<code>src/app</code>)</h1><p>\u670D\u52A1\u5668\u7EC4\u4EF6\u8D1F\u8D23\u5904\u7406\u4F20\u5165\u7684\u7F51\u7EDC\u8BF7\u6C42\uFF0C\u7BA1\u7406 SSL \u8BC1\u4E66\uFF0C\u5E76\u6839\u636E\u57DF\u540D\u914D\u7F6E\u5C06\u8BF7\u6C42\u5206\u53D1\u5230\u76F8\u5E94\u7684\u5E94\u7528\u7A0B\u5E8F\u3002\u5B83\u652F\u6301\u96C6\u7FA4\u903B\u8F91\uFF0C\u4EE5\u9AD8\u6548\u5229\u7528\u591A\u6838 CPU\u3002</p>
<h2 id="\u4E3B\u8981\u7279\u6027-key-features"><a class="header-anchor" href="#\u4E3B\u8981\u7279\u6027-key-features">#</a>\u4E3B\u8981\u7279\u6027 (Key Features)</h2><ul>
...
`;var zd=`<h1 id="lupine-api-dashboard"><a class="header-anchor" href="#lupine-api-dashboard">#</a>lupine.api dashboard</h1><p>\u8BF7\u53C2\u8003 <a href="javascript:lpPressLoad('/zh/essentials/dashboard')">Dashboard</a></p>
`;var Fd=`<h1 id="lupine-api"><a class="header-anchor" href="#lupine-api">#</a>lupine.api</h1><p>lupine.api is a fast, lightweight, and flexible node.js based server framework. It is designed to work seamlessly with <a href="https://github.com/uuware/lupine.web">lupine.web</a> to provide Server-Side Rendering (SSR) and modern API capabilities.</p>
<p>The project consists of two main parts:</p>
<ol>
<li><strong>Server (<code>src/app</code>)</strong>: A robust HTTP/HTTPS server that manages multiple applications, domains, and processes.</li>
