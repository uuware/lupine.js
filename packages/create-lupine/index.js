...
async function init() {
  ...
  const pkg = {
    ...
    '//desktop': 'If you want to build desktop applications, please run `npm run add-electron` first.',
    scripts: {
      'add-electron': 'npm install -D electron@^35.2.0 electron-builder@^26.0.12',
      ...
      dev: 'lupine-build --env=.env.development --dev=1 --cmd=start-dev',
      build: 'lupine-build --env=.env.production --dev=0 --obfuscate=0',
