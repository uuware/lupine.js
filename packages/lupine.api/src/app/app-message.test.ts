...
import { getAppCache, AppCacheKeys, AppCacheGlobal } from '../models';
...
test('AppMessage IPC Routing - Cache Refresh Broadcast Loop', async (t) => {
  ...
  t.mock.method(DebugService, 'broadcastRefresh', () => {
  ...
  t.mock.method(require('../models'), 'getAppCache', () => fakeAppCache);
