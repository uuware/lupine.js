/**
 * Converted from PHP classes/CheckIntGreaterThan0.php
 */

import { ProcessBase } from '../process-base';
import { FieldObject, VectorObject, FieldType } from '../field-objects';

export class CheckIntGreaterThan0 extends ProcessBase {
  ...
  private check(field: FieldObject | null): boolean {
    ...
    if (val !== '') {
      ...
      if (Number(val) <= 0) {
        this.addError(field, 'S_MUSTOVER0::{%N} must greater than 0.');
        return false;
      }
      field.setValue(val);
    }
