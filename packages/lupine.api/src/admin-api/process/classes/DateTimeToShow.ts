...
export class DateTimeToShow extends ProcessBase {
  ...
  override execute(): boolean | void {
    ...
    if (value.length === 19 && value.substring(8, 9) === ' ') {
      // 20091105 133714.521 -> 2009-11-05, 13:37:14, 2009-11-05 13:37:14.521
      d = value.substring(0, 4) + '-' + value.substring(4, 6) + '-' + value.substring(6, 8);
      t = value.substring(9, 11) + ':' + value.substring(11, 13) + ':' + value.substring(13, 15);
      ts = d + ' ' + t + value.substring(15);
      ...
      // 133714 -> 13:37:14
      t = value.substring(0, 2) + ':' + value.substring(2, 4) + ':' + value.substring(4, 6);
    }
