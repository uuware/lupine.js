...
import { CheckIntLessThan0 } from './CheckIntLessThan0';

describe('CheckIntLessThan0 Process', () => {
  it('CheckIntLessThan0 accepts negative integers', async () => {
    const field = makeFieldObject('field', '-12');
    const proc = new CheckIntLessThan0();
  ...
  it('CheckIntLessThan0 rejects zero', async () => {
  ...
  it('CheckIntLessThan0 rejects -0 as zero', async () => {
    const field = makeFieldObject('field', '-0');
    const proc = new CheckIntLessThan0();
    proc.setFields(field);
  ...
  it('CheckIntLessThan0 rejects positive integers', async () => {
  ...
  it('CheckIntLessThan0 rejects non-numeric values', async () => {
  ...
  it('CheckIntLessThan0 supports VectorObject validation', async () => {
  ...
  it('CheckIntLessThan0 reports the failing item in VectorObject validation', async () => {
    const field1 = makeFieldObject('field1', '-1');
