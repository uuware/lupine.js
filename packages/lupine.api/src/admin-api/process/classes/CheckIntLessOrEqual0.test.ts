...
import { CheckIntLessOrEqual0 } from './CheckIntLessOrEqual0';

describe('CheckIntLessOrEqual0 Process', () => {
  it('CheckIntLessOrEqual0 accepts zero', async () => {
    const field = makeFieldObject('field', '0');
    const proc = new CheckIntLessOrEqual0();
  ...
  it('CheckIntLessOrEqual0 accepts negative integers', async () => {
  ...
  it('CheckIntLessOrEqual0 normalizes -0 to 0', async () => {
    const field = makeFieldObject('field', '-0');
    const proc = new CheckIntLessOrEqual0();
    proc.setFields(field);
  ...
  it('CheckIntLessOrEqual0 rejects positive integers', async () => {
  ...
  it('CheckIntLessOrEqual0 rejects non-numeric values', async () => {
  ...
  it('CheckIntLessOrEqual0 supports VectorObject validation', async () => {
  ...
  it('CheckIntLessOrEqual0 reports the failing item in VectorObject validation', async () => {
  ...
  it('runProcess — rejects positive input values from context', async () => {
    const items: ItemDef[] = [makeField('value')];
    const classes: ClassDef[] = [
      {
        name: 'CheckIntLessOrEqual0',
