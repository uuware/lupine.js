...
describe('MandatoryCheck Process', () => {
  it('MandatoryCheck accepts a non-blank FieldObject', async () => {
    const field = makeFieldObject('field', 'value');
    const proc = new MandatoryCheck();
  ...
  it('MandatoryCheck rejects a blank FieldObject', async () => {
  ...
  it('MandatoryCheck accepts a VectorObject when every item is non-blank', async () => {
  ...
  it('MandatoryCheck reports only blank VectorObject items', async () => {
